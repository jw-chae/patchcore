...
except ImportError as exc:  # pragma: no cover - expected to be available in ad_env
    raise ImportError("scikit-learn is required for PatchCore metrics alignment.") from exc
